    ...
    public class RevoluteJointTest : TestBase
    {
        ...
        public RevoluteJointTest()
        {
...

            {
                ...
                shape.SetAsBox(0.25f, 3.0f, new FVector2(0.0f, 3.0f), 0.0f);
                ...
                jd.Initialize(ground, body, new FVector2(-10.0f, 20.5f));
...

            {
                ...
                polygon_shape.SetAsBox(10.0f, 0.5f, new FVector2(-10.0f, 0.0f), 0.0f);
                ...
                RevoluteJointDef jd = new RevoluteJointDef();
                jd.Initialize(ground, polygon_body, new FVector2(19.0f, 10.0f));
                jd.LowerAngle = -0.25f * Settings.Pi;
