        ...
        public SliderCrank2()
        {
...

            {
                ...
                // Define crank.
                {
                    ...
                    bd.Position = new FVector2(0.0f, 7.0f);
                    var body = World.CreateBody(bd);
                    body.CreateFixture(shape, 2.0f);

                    var rjd = new RevoluteJointDef();
                    rjd.Initialize(prevBody, body, new FVector2(0.0f, 5.0f));
                ...
                // Define follower.
                {
                    ...
                    var bd = new BodyDef {BodyType = BodyType.DynamicBody, Position = new FVector2(0.0f, 13.0f)};
                    var body = World.CreateBody(bd);
                    body.CreateFixture(shape, 2.0f);

                    var rjd = new RevoluteJointDef();
                    rjd.Initialize(prevBody, body, new FVector2(0.0f, 9.0f));
                ...
                // Define piston
                {
                    ...
                    var bd = new BodyDef
                    {
                        ...
                        Position = new FVector2(0.0f, 17.0f)
                    };
                    var body = World.CreateBody(bd);
                    body.CreateFixture(shape, 2.0f);

                    var rjd = new RevoluteJointDef();
                    rjd.Initialize(prevBody, body, new FVector2(0.0f, 17.0f));
                    World.CreateJoint(rjd);

                    var pjd = new PrismaticJointDef();
                    pjd.Initialize(ground, body, new FVector2(0.0f, 17.0f), new FVector2(0.0f, 1.0f));
                ...
                // Create a payload
                {
                    ...
                    var bd = new BodyDef();
                    bd.BodyType = BodyType.DynamicBody;
                    bd.Position = new FVector2(0.0f, 23.0f);
                    var body = World.CreateBody(bd);
                    body.CreateFixture(shape, 2.0f);
                }
            }
